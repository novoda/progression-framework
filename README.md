<p align="center">
  <a href="https://www.Novoda.com">
    <img alt="Novoda favicon" src="https://d33wubrfki0l68.cloudfront.net/673084cc885831461ab2cdd1151ad577cda6a49a/92a4d/static/images/favicon.png" width="60" />
  </a>
</p>
<h1 align="center">
...
🎉 Welcome to the Progression at Novoda repository

This is where all of Novoda's progression frameworks live, as well as the site that powers `progression.novoda.com` 💪
...
- Novodians can "own" or manage a framework (or frameworks), meaning they get to control any changes or additions in that area
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Builds relationships within Novoda and contributes to building a supportive, knowledgable and engaged peer group"
        exampleCriteria:
...
If you need any help and are a Novodian, ping @blundell a message or put a message in #helpdesk-admin. Otherwise, feel free to raise an issue here in GitHub.
...
*If you've seen the word 'repo', we're probably talking about the Progression Framework folder in GitHub that you're on right now (https://github.com/Novoda/progression-framework)*
...
Take a look at the readme in the `src/` directory (https://github.com/Novoda/progression-framework/blob/master/src/README.md)
